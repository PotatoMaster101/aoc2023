...
public readonly record struct Position : IComparable<Position>
{
    ...
    public IEnumerable<Position> GetCrossNeighbours()
    {
        return new[] { Bottom, Left, Right, Top };
    }
    ...
    public IEnumerable<Position> GetDiagonalNeighbours()
    {
    ...
    {
        return new[] { Bottom, BottomLeft, BottomRight, Left, Right, Top, TopLeft, TopRight };
    }
